...
U.init_debug = function () {
	...
	if( (location.pathname.indexOf('phone.html')  != -1) || (location.pathname.indexOf('android.html')  != -1)) {
		...
		var data = {
			mainmenu: [
				'mainmenu',
				'[["header","LiteRP",1,0,1,0,false,[null]],["gps","GPS",3,0,2,0,false,[null]],["contacts","Контакты",3,0,2,0,false,[null]],["services","Вызовы",3,0,2,0,false,[null]],["ad","Подать объявление",3,0,1,0,false,[null]],["close","Закрыть",3,0,1,0,false,[null]]]',
			],
			gps: [
				'gps',
